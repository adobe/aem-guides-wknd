...
storiesOf('Language Navigation', module)
    .add('Default', () => new LanguageNavigation("cmp-languagenavigation--default").markup)
    .add('Dark', () => new LanguageNavigation("cmp-languagenavigation--default cmp-languagenavigation--dark").markup)
