...
storiesOf('Teaser', module)
    .add('Default', () => '<div style=\'width:60%\'>' + new Teaser("").markup + '</div>')
    .add('Default CTA', () => '<div style=\'width:60%\'>' + new Teaser("").ctaMarkup + '</div>')
    .add('Featured CTA', () => '<div style="width:60%">' + new Teaser("cmp-teaser--featured").ctaMarkup + '</div>')
    .add('List', () => '<div style="width:24%; float:left;">' + new Teaser("cmp-teaser--list").markup + '</div>' + '<div style="width:24%; float:left;">' + new Teaser("cmp-teaser--list").markup + '</div>' + '<div style="width:24%; float:left;">' + new Teaser("cmp-teaser--list").markup + '</div>')
    .add('Hero', () => '<div style="width:100%">' + new Teaser("cmp-teaser--hero").ctaMarkup + '</div>')
    /*
...
class Teaser {
    ...
    get ctaMarkup() {
        return '<div class="teaser ' + this.styleClass + ' aem-GridColumn aem-GridColumn--default--12">'+
