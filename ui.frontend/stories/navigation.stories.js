...
storiesOf('Navigation', module)
    .add('Header - Desktop', () => new Navigation("cmp-navigation--header").markup)
    .add('Footer', () => '<div class=\'cmp-layout-container--footer\'>' + new Navigation("cmp-navigation--footer").markup + '</div>');
